...
class CITY(enum.Enum):
    ...
    RICHLANDS = 'Richlands'
    EMPORIA = 'Emporia'
    BIG_STONE_GAP = 'Big Stone Gap'
    BLUEFIELD = 'Bluefield'
    WOODSTOCK = 'Woodstock'
    DUMFRIES = 'Dumfries'
    ORANGE = 'Orange'
    LURAY = 'Luray'
    ROCKY_MOUNT = 'Rocky Mount'
    SOUTH_HILL = 'South Hill'
    TAZEWELL = 'Tazewell'
    BERRYVILLE = 'Berryville'
    NORTON = 'Norton'
    BROADWAY = 'Broadway'
    CLIFTON_FORGE = 'Clifton Forge'
    BLACKSTONE = 'Blackstone'
    COLONIAL_BEACH = 'Colonial Beach'
    ALTAVISTA = 'Altavista'
    LEBANON = 'Lebanon'
    ...
    CHASE_CITY = 'Chase City'
    CREWE = 'Crewe'
    AMHERST = 'Amherst'
    NEW_MARKET = 'New Market'
    WAVERLY = 'Waverly'
    SALTVILLE = 'Saltville'
    MOUNT_JACKSON = 'Mount Jackson'
    COEBURN = 'Coeburn'
    GATE_CITY = 'Gate City'
    HAYMARKET = 'Haymarket'
    NARROWS = 'Narrows'
    STEPHENS_SITY = 'Stephens Sity'
    LOVETTSVILLE = 'Lovettsville'
    PENNINGTON_GAP = 'Pennington Gap'
    CHILHOWIE = 'Chilhowie'
    ...
    WARSAW = 'Warsaw'
    RURAL_RETREAT = 'Rural Retreat'
    CHATHAM = 'Chatham'
    GLADE_SPRING = 'Glade Spring'
    STUART = 'Stuart'
